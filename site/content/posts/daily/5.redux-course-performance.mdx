---
title: "Redux Toolkit: Performance Optimization — Memoized Selectors & Clean UI Rendering"
category: Daily
...
If we compute derived data inside components, it re-computes on *every render*, even if data didn’t change.
