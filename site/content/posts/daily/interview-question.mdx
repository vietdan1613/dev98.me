...
> Why did you use Redux-Saga instead of Redux Thunk or only React Query?
> (decision-making and async complexity handling)
...
> How did Redux-Saga and React Query work together without overlapping responsibilities?
> (real-world state architecture maturity)
> * Saga for orchestration / workflows
> * React Query for server state + caching
> * Avoiding duplication
> * When data lived in Redux vs Query cache

> What performance problems did you face and how did you fix them?
> (Senior engineers are judged on this)
...
> What technical decisions did you personally own?
