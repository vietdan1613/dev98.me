---
title: "Advanced Hook: createContext()"
category: React
...
> Sometimes, multiple components need access to the same state. While lifting state up works in many cases, it becomes impractical when components are deeply nested or separated by routers or layout boundaries. This is where **React Context** becomes essential.
